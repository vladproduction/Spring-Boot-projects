...
public class MainApp {
    public static void main(String[] args) {
        ...
        Dao daoPassengerImpl = (Dao) context.getBean("daoPassengerImpl");
        daoPassengerImpl.getPassenger(1);
        daoPassengerImpl.getPassenger(1);

        System.out.println("=======insert========");
        Passenger peter = new Passenger();
        peter.setName("Peter");
        peter.setCountry("SWEDEN");
        //"SE" + "SWE"

        daoPassengerImpl.insert(peter);
